...
If it works, confirm what's playing. If playback fails (no active device), remind them to open Spotify and let them know they can test later with `/music <mood>`.
